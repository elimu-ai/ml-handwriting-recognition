...
import config
from data import get_lab,clean_train_lab,clean_labels,distortion_free_resize
from model import build_model,decoder
from utils import convert_tflite,CTCDecoder
...
def main():
    ...
    def calculate_edit_distance(labels, predictions):
        ...
        print("Shapes")
        print(sparse_predictions.shape)
